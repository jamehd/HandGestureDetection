import GetureDetection
import cv2

cap = cv2.VideoCapture(0)
hist = GetureDetection.capture_histogram(source=0)
...
while True:
    ...
    GetureDetection.detect_face(frame, block=True)
    hand = GetureDetection.detect_hand(frame, hist)
